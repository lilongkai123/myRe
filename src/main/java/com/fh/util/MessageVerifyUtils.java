...
public class MessageVerifyUtils {
    ...
    static final String accessKeyId = "LTAI4GKiL1FvfC4i4eD9o8jw";           // TODO 改这里
    static final String accessKeySecret = "gnJPwlwX8zdWuYyHHXUSCY950OJIXk"; // TODO 改这里
    public static SendSmsResponse sendSms(String userPhone, String userCode) throws ClientException {
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("llk商城"); // TODO 改这里
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_196642930");  // TODO 改这里
